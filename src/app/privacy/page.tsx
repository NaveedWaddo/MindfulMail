      ...
      <>
        <div className="mx-auto max-w-5xl px-8 sm:mt-10">
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            ...
            technologies, such as cookies. Information that is collected with
            ...
            of such technologies on www.mindfulmail.com and other sites.
          </p>
          <h3 className="mb-5 text-left text-2xl font-semibold text-gray-600">
            Children
          </h3>
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            ...
            information that we process on behalf of our customers, as a
            processor or service provider. Our customers are the controller (or
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            ...
            controls and encryption to keep personal information private while
            in transit. We only retain personal information as long as necessary
            to fulfill the purposes for which it is processed, or to comply with
          ...
          <ul className="mb-10 mt-5 list-inside list-disc text-justify leading-relaxed text-gray-600">
            ...
            <li>
              and the establishment, exercise, or defense of legal claims in the
          ...
          <ul className="mb-10 mt-5 list-inside list-disc text-justify leading-relaxed text-gray-600">
            <li>
              ...
              may have additional rights concerning your personal information.
            </li>
            <li>
              request to obtain your personal information in a usable format and
              transmit it to another party (also known as the right to data
              portability).
            </li>
            <li>
              request to delete the personal information we hold information
              processing types, such as targeted advertising.
            </li>
            <li>
              ask questions related to this Privacy Statement and privacy
              practices.
            </li>
            <li>
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            ...
            services after a revision takes effect, it is considered that users
